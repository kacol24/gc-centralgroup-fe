...
export default function CustomerGathering() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/customer-gathering/thankyou');
    ...
    if (currentStep === 1) {
      ...
      try {
        ...
        if (response.submitRaffle.status) {
          ...
          router.push('/customer-gathering/thankyou');
  ...
  const shareToFacebook = () => {
    ...
    const text = `Selamat Datang di Gathering & Dinner Session Central Group!

Bergabunglah dalam acara Gathering & Dinner Session eksklusif bersama Central Group. Dapatkan promo spesial, bonus menarik, dan doorprize!

#GatheringCentralGroup #CentralGroup`;
  ...
  return (
    <section className="w-full h-auto pt-[120px] md:pt-[150px] lg:pt-[170px] xl:pt-[223px] bg-backgroundWhite min-h-screen pb-20 md:pb-28 lg:pb-36 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ✨ SELAMAT DATANG DI UNDANGAN GATHERING CENTRAL GROUP ✨
        </h1>
        ...
        <div data-aos="fade-up" data-aos-duration="1200" className="w-full mb-8 md:mb-12 lg:mb-16">
          <div className="w-full bg-gray-200 rounded-sm overflow-hidden">
            ...
            <Image
              src="/assets/image/customer-gathering.webp"
              alt="Customer Gathering Banner"
              width={1200}
              height={400}
              ...
              onError={(e) => {
                ...
                target.parentElement!.innerHTML =
                  '<div class="w-full h-[300px] bg-gradient-to-r from-green-900 to-green-700 flex items-center justify-center text-white text-2xl font-bold">CUSTOMER GATHERING</div>';
              }}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-[132px]">
          ...
          >
            <div className="text-sm leading-relaxed text-textPrimary space-y-4">
              <p>Terima kasih atas waktu dan ketertarikan Anda terhadap project Central Group 🙏</p>
              <p>
                Dengan bangga kami mengundang Bapak/Ibu untuk menghadiri jamuan makan malam special di acara{' '}
                <strong>Gathering &amp; Dinner Session</strong> bersama konsumen dan calon customer dalam suasana yang
                lebih santai dan eksklusif.
              </p>
              <p>
                Pada kesempatan ini, Bapak/Ibu dapat mengenal lebih jauh mengenai project Central Group, fasilitas
                kawasan, program pembelian, hingga konsultasi seputar KPR dan investasi properti secara langsung bersama
                tim kami.
              </p>
              <p>✨ Disediakan juga berbagai promo spesial, bonus menarik, serta doorprize untuk peserta gathering.</p>
              <p>
                Semoga acara ini dapat menjadi momen yang menyenangkan sekaligus memberikan informasi yang bermanfaat
                bagi Bapak/Ibu dan keluarga.
              </p>
              <p>Terima kasih atas perhatian dan kepercayaannya kepada Central Group 🏡</p>
            </div>
