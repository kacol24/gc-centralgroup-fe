...
export default function OpenHouse() {
  ...
  useEffect(() => {
    ...
    router.prefetch('/open-house/thankyou');
    ...
    if (currentStep === 1) {
      ...
      try {
        ...
        if (response.submitRaffle.status) {
          ...
          router.push('/open-house/thankyou');
  ...
  const shareToFacebook = () => {
    ...
    const text = `Selamat Datang di Open House Central Group!

Kunjungi open house kami dan dapatkan promo spesial, konsultasi KPR gratis, serta hadiah menarik!

#OpenHouse #CentralGroup`;
  ...
  return (
    <section className="w-full h-auto pt-[120px] md:pt-[150px] lg:pt-[170px] xl:pt-[223px] bg-backgroundWhite min-h-screen pb-20 md:pb-28 lg:pb-36 overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          🎉 SELAMAT DATANG DI OPEN HOUSE CENTRAL GROUP 🎉
        </h1>
        ...
        <div data-aos="fade-up" data-aos-duration="1200" className="w-full mb-8 md:mb-12 lg:mb-16">
          <div className="w-full bg-gray-200 rounded-sm overflow-hidden">
            ...
            <Image
              src="/assets/image/open-house.webp"
              ...
              onError={(e) => {
                ...
                target.parentElement!.innerHTML =
                  '<div class="w-full h-[300px] bg-gradient-to-r from-green-900 to-green-700 flex items-center justify-center text-white text-2xl font-bold">OPEN HOUSE</div>';
              }}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-[132px]">
          ...
          >
            <div className="text-sm leading-relaxed text-textPrimary space-y-4">
              <p>Terima kasih sudah meluangkan waktu untuk mengenal project Central Group 🙏</p>
              <p>
                Kami percaya, memilih rumah bukan hanya tentang membeli bangunan… tetapi tentang mempersiapkan tempat
                terbaik untuk masa depan dan keluarga tercinta ❤️
              </p>
              <p>
                Nikmati pengalaman melihat langsung rumah impian dengan lokasi strategis, desain modern, dan berbagai
                promo spesial yang sayang untuk dilewatkan ✨
              </p>
              <p>
                <strong>🎁 Khusus pengunjung Open House, tersedia:</strong>
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Promo harga spesial</li>
                <li>Bonus &amp; penawaran menarik</li>
                <li>Kesempatan mendapatkan hadiah langsung</li>
                <li>Konsultasi GRATIS seputar KPR &amp; properti</li>
              </ul>
              <p>
                <strong>📅</strong> Open House rutin diadakan setiap weekend
              </p>
              <p>⏰ Jangan lewatkan kesempatan terbaik untuk memiliki rumah impian Anda bersama Central Group!</p>
              <p>
                Ajak keluarga &amp; sahabat Anda, dan rasakan langsung suasana hunian terbaik pilihan masyarakat Batam
                🏡✨
              </p>
            </div>
