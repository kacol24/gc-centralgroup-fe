...
import { iconBook, iconFish, iconHome, iconPlus } from '../../lib/utils/svg';

export default function CentralHome() {
  const centralHomePillars = [
    {
      title: 'SUSPERNDISE',
      description:
  ...
  return (
    <>
      ...
      <CentralCommunityBanner
        ...
        bannerImageTop={backgroundTopBannerPageCentralHome}
        bannerImageBottom={backgroundBottomBannerPageCentralHome}
        ...
        pillarItems={centralHomePillars}
        pillarsIconBackground="bg-primary"
      />

      <CentralCommunityGoal goals={centralHomeGoals} />
