...
export default function CentralPropertyAcademy() {
  const centralPropertyAcademyPillars = [
    {
      title: 'SUSPERNDISE',
      description:
  ...
  const centralPropertyAcademyGoals = [
    {
      title: 'VISION',
      description:
        'Aliquam malesuada enim ut risus vulputate pretium morbi molestie. Sit non morbi libero nibh morbi in aliquet. Auctor quis nisl pretium leo mauris aliquet enim quis.',
  ...
  return (
    <>
      ...
      <CentralCommunityGoal goals={centralPropertyAcademyGoals} />
