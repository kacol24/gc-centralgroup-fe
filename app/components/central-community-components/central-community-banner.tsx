    ...
    <section>
      ...
      >
        ...
        <div className="z-20 container w-[80%] m-auto text-center">
          <h1 className="mb-12 text-4xl text-center uppercase lg:text-6xl">{bannerTitle}</h1>
          <p className="mb-20 text-sm text-center md:w-[80%] md:mx-auto">{bannerDescription}</p>
        </div>
      </div>

      <div className="bg-cover bg-center" style={{ backgroundImage: `url(${bannerImageBottom.src})` }}>
        <div className="container w-auto relative p-12 md:mx-8 md:py-8 md:px-0 lg:mx-auto">
          <div className="relative -top-72 -mb-72 md:-top-80 md:-mb-80 lg:-top-64 lg:-mb-24">
            <div className="flex items-center gap-2 md:justify-between">
              ...
              <h2 className="text-2xl text-center">{pillarTitle}</h2>
              <div className="w-[20%] h-[1px] bg-white lg:w-[25%]" />
            </div>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-x-8 lg:grid-cols-4">
              {pillarItems.map((pillar, index) => (
                ...
                >
                  ...
                  <h3 className="mb-6 text-2xl text-center text-textPrimary">{pillar.title}</h3>
